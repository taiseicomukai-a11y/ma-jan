...
import { isWinningHand } from "../src/lib/mahjong/hand";
import { calcShanten, minAdditionalTilesToWin } from "../src/lib/mahjong/shanten";
import { analyzeHand, calculateUkeireForDiscard } from "../src/lib/mahjong/ukeire";
...
describe("ukeire", () => {
  it("calculates effective tile types and remaining counts for a discard", () => {
